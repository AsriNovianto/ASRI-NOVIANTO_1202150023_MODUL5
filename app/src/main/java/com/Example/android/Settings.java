...
public class Settings extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        color = findViewById(R.id.shapecolor);
    ...
    //mendapatkan string color yang akan digunakan untuk mengubah shape color
    ...
    //mendapatkan id dari color yang akan digunakan
